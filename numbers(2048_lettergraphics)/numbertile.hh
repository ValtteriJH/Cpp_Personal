...
public:
    ...
    * */
    ...
    // Reads the coordinates of the tile and returns the <x,y> pair
    pair<int,int> getCoords();

    // Moves the tile/number according to input. Returns true if tile moves succesfully.
...
private:
    ...
    // coordinates of the tile in an <y,x> pair
